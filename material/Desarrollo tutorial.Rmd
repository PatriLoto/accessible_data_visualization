...
```{r, fig.alt = "figura con dos visualizaciones, una con buen contraste y otra con un contraste deficiente", out.width = "50%"}
...
```{r, echo=FALSE, fig.alt = "Figura con un ejeplo donde se etiquetan los puntos para mejorar la legibilidad", out.width = "50%"}
